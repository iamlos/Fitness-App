...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Classes Page
            <a href="{{ url('classes/create') }}" class="btn btn-success btn-sm pull-right">Add New</a>
        </h1>
    </div>
</div>
                        ...
                        @foreach($classes as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('classes.edit', $row->id) }}" class="btn btn-info btn-sm">Edit</a>
                                    <a href="{{ route('classes.delete', $row->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                        <?php $no++; ?>
                        @endforeach
